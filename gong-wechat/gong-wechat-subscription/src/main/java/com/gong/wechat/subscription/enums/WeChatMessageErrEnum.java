...
public enum WeChatMessageErrEnum implements BaseEnum<Long> {
    ...
    WeChatMessageErrEnum(long code, String msg) {
        this.code = code;
        this.msg = msg;
    }
    ...
    public static WeChatMessageErrEnum findByValue(Long code) {
        if (ObjectUtils.isEmpty(code)) {
            return null;
        }
        for (WeChatMessageErrEnum enumValue : values()) {
