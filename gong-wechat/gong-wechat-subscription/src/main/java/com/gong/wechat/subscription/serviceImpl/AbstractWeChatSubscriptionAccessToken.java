...
public abstract class AbstractWeChatSubscriptionAccessToken implements WeChatSubscriptionAccessToken {
    ...
    public AbstractWeChatSubscriptionAccessToken(WeChatSubscriptionProperties properties) {
        super();
    ...
    public synchronized void refreshAccessToken() {
        ...
        WeChatAccessTokenResponse response = accessToken();
    ...
    private WeChatAccessTokenResponse accessToken() {
        ...
        return httpClient.get(url.toString()).map(r -> {
            ...
            return JSONObject.parseObject(r, WeChatAccessTokenResponse.class);
        }).orElse(null);
    }
}
