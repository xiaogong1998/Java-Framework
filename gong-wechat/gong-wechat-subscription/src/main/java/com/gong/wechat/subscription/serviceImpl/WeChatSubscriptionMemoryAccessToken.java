...
public class WeChatSubscriptionMemoryAccessToken extends AbstractWeChatSubscriptionAccessToken {

    public WeChatSubscriptionMemoryAccessToken(WeChatSubscriptionProperties properties) {
        super(properties);
    }
